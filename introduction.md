...
urgently need simplification and easy management. 

In response to this trend, Huawei developed EulerOS iSula, an open-source container-based OS.
This project will enable Huawei to explore flexible build processes,
